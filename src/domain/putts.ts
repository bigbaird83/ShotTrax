 ...
 * stays for off-green chip-ins and flags the last real mark only.
 * Never a third dock row. Never invent putt GPS or green-edge polygons.
 */
...
/** Signal: Putt is putter or ≤40 yd good/soft — not always-on. */
