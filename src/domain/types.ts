...
/** How the shot was logged. `no_gps` never stores coordinates. `placed` is a player map tap (catch-up). */
...
export type Shot = {
  ...
  /** Haversine yards from GPS marks or consecutive placed map points. Always null on `no_gps`. */
