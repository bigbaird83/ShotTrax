...
export const COPY = {
  ...
  howTo: 'How to play',
  howToMark: 'Pick a club → walk → press to mark',
  howToFinish: 'Finish hole for a chip-in or hole-out off the green.',
  finishHole: 'Finish hole',
  finishHoleNeedsClub: 'Pick a club to finish the hole.',
  holedOut: 'Holed out',
