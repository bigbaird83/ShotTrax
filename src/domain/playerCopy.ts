...
export const COPY = {
  ...
  groupSaved: 'Saved',
  groupNotSaved: 'not saved',
  groupHoldToClear: 'Press and hold to clear this score.',
  groupClearTitle: 'Clear score for',
  groupClearBody: 'This removes the saved score for this hole.',
  groupClearConfirm: 'Clear score',
  groupPlayers: 'Players',
  groupName: 'Name',
  groupHandicap: 'Course handicap',
  groupHandicapOptional: 'Course handicap (optional)',
  groupHcpShort: 'Hcp',
  groupNoHcp: 'No handicap',
  groupAddPlayer: 'Add player',
  groupRecent: 'Recent',
  groupRemoveRecent: 'Remove from recent',
  groupRemoveRecentTitle: 'Remove from recent',
  groupRemoveRecentBody: 'This takes them off the recent list on this phone. It does not change any round.',
  groupHoldToRemoveRecent: 'Press and hold to remove from recent.',
  groupEdit: 'Edit',
  groupSave: 'Save',
  groupRemove: 'Remove player',
  groupFull: 'Four players is the most in a group.',
  groupNeedsName: 'Enter a name first.',
  groupLeaderboard: 'Leaderboard',
  groupLeaderboardNet: 'Leaderboard (net)',
  groupNetToParLabel: 'Net to par, with strokes off the lowest handicap — the low player’s net is their gross.',
  groupNetTotalLabel: 'Net total strokes, with strokes off the lowest handicap — the low player’s net is their gross.',
  groupNetBlocked: 'Net needs a stroke index on every hole where someone gets a stroke, so games are gross for this course.',
  groupNetNeedsHandicaps: 'Net needs a course handicap for every player. Games stay gross until each one is filled in.',
  groupNetHow:
    'Leaderboard and skins: strokes off the group’s lowest handicap. Match play and Nassau: off the lower of the two players. Stableford: full course handicaps.',
  groupNetHalved: 'On 9 holes, strokes are halved (rounded).',
  ...
  groupCardSkins: 'Boxed: skin won, with its value',
  groupCardUnder: 'Green: under par',
  groupHideRules: 'Hide rules',
  groupScoreDown: 'one less',
  groupScoreUp: 'one more',
  groupSkinsTiedAtEnd: 'tied on the last hole — not won',
  groupSkinsWaitingPrefix: 'Skins are waiting on hole',
  groupSkinsWaitingSuffix: 'Holes after it count once that score is in.',
  groupGames: 'Games',
  groupNet: 'Net (use handicaps)',
  groupSkins: 'Skins',
  groupSkinsCarry: 'Ties carry over',
  groupSkinsCarrying: 'riding on the next hole',
  groupStableford: 'Stableford',
  groupMatchPlay: 'Match play',
  groupNassau: 'Nassau',
  groupMatchPick: 'Match between (pick two)',
  handicap: 'Handicap',
  trends: 'Trends',
