...
export const COPY = {
  ...
  restoreRoundsConfirm: 'Restore rounds from this file? Existing rounds with the same id will be replaced.',
  ...
  nerdOut: 'Nerd out',
  nerdOutLede: 'Score vs par and putts from saved rounds.',
